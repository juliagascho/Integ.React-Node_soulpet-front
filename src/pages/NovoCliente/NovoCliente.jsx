...
export function NovoCliente() {
    ...
    // http://localhost:3001/clientes = rota no back pra salvar o cliente
    //data é o objeto que a gente tá passando no corpo da requisição. no back: const {nome, email, telefone, endereco} = req.body
    // response = res.send
